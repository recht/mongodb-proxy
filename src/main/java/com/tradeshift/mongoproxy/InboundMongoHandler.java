...
public class InboundMongoHandler extends SimpleChannelUpstreamHandler {
     ...
     public InboundMongoHandler(ClientSocketChannelFactory cf, String remoteHost, int remotePort) {
         this.cf = cf;
